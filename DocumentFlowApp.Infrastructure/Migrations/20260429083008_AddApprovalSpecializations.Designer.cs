...
namespace DocumentFlowApp.Infrastructure.Migrations
{
    ...
    [Migration("20260429083008_AddApprovalSpecializations")]
    partial class AddApprovalSpecializations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DocumentFlowApp.Core.Entities.DocumentApprovalStep", b =>
                {
                    ...
                    b.Property<string>("ApproverSpecialization")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("DocumentFlowApp.Core.Entities.User", b =>
                {
                    ...
                    b.Property<string>("ApprovalSpecialization")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
